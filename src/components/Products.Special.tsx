        ...
        <Section sectionClass='products-special'>
            <div className='products-wrapper'>
                ...
                <div className='slider products-special-slider'>
                    ...
                    <img src={cakes[4]} alt='' />
                    <svg x='0px' y='0px' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 500 500' style={{strokeWidth:'12px', fill:'transparent', stroke:'#5fcac7'}}>
                    ...
                    <div className='slider-item'><img src={cakes[1]} alt='' /></div>
                    <div className='slider-item'><img src={cakes[2]} alt='' /></div>
                    <div className='slider-item'><img src={cakes[3]} alt='' /></div>
                </div>
            </div>
        </Section>
    );
