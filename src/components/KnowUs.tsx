...
const arr = ['apple-pie', 'medal', 'food', 'cupcake'];

interface IKnowUsItem {
    icon: string;
}

const KnowUsItem = ({ icon }: IKnowUsItem) => {
    return (
        <div className='knowus-item'>
            <div className='knowus-item-image'>
            ...
            <div className='knowus-item-text'>
...
class KnowUs extends React.Component<{}, {}> {
    ...
    renderGrid = () => {
        return (
            arr.map((item, index) => {
                return (
                    <KnowUsItem icon={item} key={index} />
                );
            })
        );
    }
    ...
    render() {
        return (
            <Section sectionClass='knowus'>
                <div className='knowus-wrapper'>
